...
func (usuario usuarioImplementacion) PublicarPost(arr []string, dicc TDAHeap.Diccionario[K, V], post Post, afinidad int) {
...
func (usuario *usuarioImplementacion) ScrollFeed() error {
